...
public class UpravljanjeZadatkom {
	...
	public void kreiranjeNovogZadatka(String opisZadatka, boolean statusZadatka, String imeVlasnika,
	...
	public void editovanjeZadatka(int brojZadatka, String editovaniTekst, ArrayList<Zadatak> adaci) {
		if (zadaci.size() > 0) {
	...
	public void izlistavanjeZadataka(ArrayList<Zadatak> zadaci) {
		for (int i = 0; i < zadaci.size(); i++) {
			System.out.println((i + 1) + ". Ime vlasnika: " + zadaci.get(i).getImeVlasnika() + ", opis zadatka: "
					+ zadaci.get(i).getOpisZadatka() + ", datum i vrijeme kreiranja zadatka:  "
